...
public enum GifError {
    ...
    READ_FAILED(ParserMinimalBase.INT_f, "Failed to read from given input"),
    ...
    CLOSE_FAILED(ParserMinimalBase.INT_n, "Failed to close given input"),
    ...
    NO_FRAMES(JsonMappingException.MAX_REFS_TO_LIST, "No frames found, at least one frame required"),
