...
public interface TraceEventType {
    ...
    public static final String AltSvc = "AltSvc";
    ...
    public static final String DecompressionPersistentConnection = "decompression_persistent_connection_filter";
    ...
    public static final String HTTPPerfParameters = "HTTPPerfParameters";
    public static final String Ifaddress = "Ifaddress";
    ...
    public static final String RetryFilter = "RetryFilter";
    ...
    public static final String TLSCachedInfo = "TLSCachedInfo";
