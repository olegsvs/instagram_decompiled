...
public final class MatrixMathHelper {
    ...
    public final class MatrixDecompositionContext {
    ...
    public static void decomposeMatrix(double[] dArr, MatrixDecompositionContext matrixDecompositionContext) {
        double[] dArr2 = dArr;
        AnonymousClass0LR.B(dArr2.length == 16);
        ...
        if (!isZero(dArr2[15])) {
            ...
            if (!isZero(determinant(dArr9))) {
                ...
                if (isZero(dArr8[0][3]) && isZero(dArr8[1][3])) {
                    if (isZero(dArr8[2][3])) {
                        dArr3[2] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
                        dArr3[1] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
                        dArr3[0] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
                        dArr3[3] = 1.0d;
                        for (i4 = 0; i4 < 3; i4++) {
                            dArr6[i4] = dArr8[3][i4];
                        }
                        ...
                        v3Normalize = v3Normalize(dArr10[0], dArr4[0]);
                        dArr10[0] = v3Normalize;
                        dArr5[0] = v3Dot(v3Normalize, dArr10[1]);
                        dArr10[1] = v3Combine(dArr10[1], dArr10[0], 1.0d, -dArr5[0]);
                        dArr5[0] = v3Dot(dArr10[0], dArr10[1]);
                        v3Combine = v3Combine(dArr10[1], dArr10[0], 1.0d, -dArr5[0]);
                        dArr10[1] = v3Combine;
                        dArr4[1] = v3Length(v3Combine);
                        ...
                        v3Combine = v3Combine(dArr10[2], dArr10[1], 1.0d, -dArr5[2]);
                        dArr10[2] = v3Combine;
                        dArr4[2] = v3Length(v3Combine);
                        dArr10[2] = v3Normalize(dArr10[2], dArr4[2]);
                        dArr5[1] = dArr5[1] / dArr4[2];
                        dArr5[2] = dArr5[2] / dArr4[2];
                        if (v3Dot(dArr10[0], v3Cross(dArr10[1], dArr10[2])) < StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED) {
                            for (i6 = 0; i6 < 3; i6++) {
    ...
    public static double[] inverse(double[] dArr) {
        ...
        double d36 = d7 * d9;
        double d37 = d5 * d11;
        dArr2[4] = ((((((d18 * d13) - (d17 * d13)) - (d35 * d15)) + (d17 * d15)) + (d36 * d16)) - (d37 * d16)) / determinant;
        d18 = d4 * d9;
        d23 = d * d12;
        double d38 = d3 * d9;
        double d39 = d * d11;
        dArr2[5] = ((((((d24 * d13) - (d23 * d13)) + (d18 * d15)) - (d23 * d15)) - (d38 * d16)) + (d39 * d16)) / determinant;
        d4 *= d5;
        d8 *= d;
        d3 *= d5;
        d7 *= d;
        ...
        d35 = d6 * d9;
        d17 = d5 * d10;
        dArr2[8] = ((((((d20 * d13) - (d19 * d13)) + (d35 * d14)) - (d17 * d14)) - (d35 * d16)) + (d17 * d16)) / determinant;
        d18 = d2 * d9;
        d23 = d * d10;
        dArr2[9] = ((((((d25 * d13) - (d26 * d13)) - (d18 * d14)) + (d23 * d14)) + (d18 * d16)) - (d23 * d16)) / determinant;
        d2 *= d5;
        d *= d6;
        ...
        dArr2[12] = ((((((d21 * d13) - (d22 * d13)) - (d36 * d14)) + (d37 * d14)) + (d35 * d15)) - (d17 * d15)) / determinant;
        dArr2[13] = ((((((d28 * d13) - (d27 * d13)) + (d38 * d14)) - (d39 * d14)) - (d18 * d15)) + (d23 * d15)) / determinant;
    ...
    public static void multiplyInto(double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        double d23 = dArr3[14];
        double d24 = dArr3[15];
        dArr[12] = (((d * d21) + (d5 * d22)) + (d9 * d23)) + (d13 * d24);
        dArr[13] = (((d2 * d21) + (d6 * d22)) + (d10 * d23)) + (d14 * d24);
        dArr[14] = (((d3 * d21) + (d7 * d22)) + (d11 * d23)) + (d15 * d24);
        dArr[15] = (((d21 * d4) + (d22 * d8)) + (d23 * d12)) + (d24 * d16);
    }
    ...
    public static void resetIdentityMatrix(double[] dArr) {
        dArr[14] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[13] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[12] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[11] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[9] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[8] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[7] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[6] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[4] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[3] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[2] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[1] = StartupQEsConfig.DEFAULT_FPS_MODIFIY_FEED_SPEED;
        dArr[15] = 1.0d;
        dArr[10] = 1.0d;
        dArr[5] = 1.0d;
        dArr[0] = 1.0d;
